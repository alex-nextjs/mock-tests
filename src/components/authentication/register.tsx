...
export default function Register() {
  ...
  return (
    <div className="w-full max-w-md lg:space-y-0 space-y-8">
      <motion.div
      ...
      >
        <Umbrella className="text-teal-600 dark:text-teal-400" />
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-1">Create an account</h1>
        <p className="text-gray-600 dark:text-gray-300">to continue to SSCPrep</p>
      </motion.div>
      ...
      >
              ...
              render={({ field }) => (
                <FormItem className="flex items-start space-x-2">
                  ...
                  <FormLabel className="text-sm text-gray-600 dark:text-gray-300 leading-tight">
                    I agree to the{" "}
                    <Link href="/terms" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
                      Terms
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
                      Privacy Policy
                    </Link>
                  </FormLabel>
                  <FormMessage />
        ...
        <p className="text-center text-gray-600 dark:text-gray-300">
          ...
          <Link href="/auth/login" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
            Log In
          </Link>
        </p>
      </motion.div>
